...
import com.azmiradi.invitations.FirebaseConstants.APPLICATIONS
...
import com.azmiradi.invitations.local_database.AppDatabase
import com.azmiradi.invitations.local_database.PreferenceHelper
import com.azmiradi.invitations.local_database.PreferenceHelper.isOffline
        ...
        if (isOffline()) {
            ...
            FirebaseDatabase.getInstance().reference.addListenerForSingleValueEvent(object :
                ...
                override fun onDataChange(snapshot: DataSnapshot) {
                    ...
                    for (data in snapshot.child(APPLICATIONS).children) {
                        if (data.getValue(ApplicationPojo::class.java)?.nationalID == invitationNumber) {
